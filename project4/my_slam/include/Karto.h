...
namespace karto
{
  ...
  private:
     ...
     */
    LaserRangeFinder(const Name& rName) : Sensor(rName), m_NumberOfRangeReadings(0)
    {
  ...
  public:
     ...
     */
    LaserRangeScan(const Name& rSensorName, const RangeReadingsVector& rRangeReadings): SensorData(rSensorName), m_pRangeReadings(NULL), m_NumberOfRangeReadings(0)
    {
